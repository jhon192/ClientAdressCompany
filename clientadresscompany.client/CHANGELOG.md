...
- Create Angular project with ng: `ng new clientadresscompany.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`clientadresscompany.client.esproj`).
